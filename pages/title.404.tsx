...
export default function Title404() {
    return (
        <Head>
            ...
            <title>404 - Page Not Found | Ayush Kumar Tiwari</title>
            ...
            <meta name="keywords" content="404, Page Not Found, Ayush Kumar Tiwari, Portfolio,broken link ,missing page,link not found" />
