...
export default function Title500() {
    return (
        <Head>
            ...
            <title>500: internal server error | Ayush Kumar Tiwari</title>
            ...
            <meta name="keywords" content="500, internal server error, Ayush Kumar Tiwari, Portfolio,broken link ,missing page,link not found" />
